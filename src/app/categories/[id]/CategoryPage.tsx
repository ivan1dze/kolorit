...
export default function CategoryPage({ params }: { params: Promise<Params> }) {
    ...
    const fetchData = async () => {
        const res = await fetch(`https://api.colordrive.by/api/categories/${categoryId}/products/`);
    ...
    const applyFilters = async () => {
        ...
        const res = await fetch(`https://api.colordrive.by/api/categories/${categoryId}/products/filter/`, {
            method: 'POST',
